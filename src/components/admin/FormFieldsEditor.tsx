    ...
    <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-6">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="flex items-center gap-2 text-[16px] font-bold text-white">
          <span className="rounded bg-purple-500/15 px-2 py-0.5 text-[11px] font-bold text-purple-400">
            FORM
          </span>
      ...
      {fields.length === 0 && (
        <p className="py-8 text-center text-[13px] text-gray-500">
          Aucun champ. Ajoutez des champs pour permettre les inscriptions à
          cette formation.
        </p>
      )}
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="2"
                    className={`text-gray-500 transition-transform ${expandedId === field.id ? "rotate-180" : ""}`}
                  >
                    <polyline points="6 9 12 15 18 9" />
                  </svg>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        value={field.labelFr}
                        onChange={(e) =>
                          updateField(field.id, { labelFr: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <input
                        value={field.labelEn}
                        onChange={(e) =>
                          updateField(field.id, { labelEn: e.target.value })
                        }
